          ...
          <div className="fixed bottom-4 right-4 z-30 flex flex-col items-end gap-2">
            ...
            {showScrollTop && (
              <button
                ...
                className="w-9 h-9 rounded-full bg-white text-slate-700 border border-slate-200 shadow-md flex items-center justify-center transition-all hover:bg-slate-100 cursor-pointer"
            ...
            <a
              ...
              className="flex items-center gap-2 px-3.5 py-2.5 rounded-full bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-xs shadow-lg shadow-emerald-600/30 transition-all cursor-pointer"
            ...
            {cartTotalItems > 0 && (
              <button
                ...
                className="md:hidden flex items-center gap-2 px-3.5 py-2.5 rounded-full bg-blue-600 text-white font-bold text-xs shadow-lg shadow-blue-600/30 cursor-pointer"
                aria-label="Ver carrinho"
              >
                <ShoppingBag className="w-4 h-4" />
                <span>
                  {cartTotalItems} ({formatKzCompact(cartTotalAmount, siteConfig.currencySymbol, siteConfig.currencyPosition)})
                </span>
              </button>
            )}
          </div>
